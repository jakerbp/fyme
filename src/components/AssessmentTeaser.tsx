  ...
  return (
    <section className="py-16 md:py-24 bg-muted">
      <div className="container px-4 md:px-6 max-w-3xl mx-auto text-center">
        ...
        Truly understanding your edge demands answering tough questions. This assessment requires honesty and the willingness to dig deep into your psyche. Are you ready?
        </p>
